(function ()
{
    ...
    /** @ngInject */
    function apiService($resource, $window)
    {
        /**
        ...
        api.user = {
            list     : $resource('http://api.example.com/blog'),
            login  : $resource('https://www.metrokidscompany.com/kulisha/api/Login/login/:user/:pass', 
                    {user: '@user', 'pass' : '@pass'}),
            getByDate: $resource('http://api.example.com/blog/:date', {id: '@date'}, {
                get: {
                    method: 'GET',
        ...
        api.colors = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/color'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'color', lang: $window.localStorage.getItem('lang')}),
            update  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/update/:id/:table/:p1/:p2/:p3', 
                    {id: '9', 'table' : 'color', 'p1': 'aaa', 'p2': 'ddd', 'p3': 'ddd'})
        }
        
        api.compositions = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/composition'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'composition', lang: $window.localStorage.getItem('lang')}),
        }

        api.collections = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/collection'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'collection', lang: $window.localStorage.getItem('lang')}),
        }

        api.sections = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/section'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'section', lang: $window.localStorage.getItem('lang')}),
        }
        
        api.familys = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/family'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'family', lang: $window.localStorage.getItem('lang')}),
        }
        
        api.lines = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/line'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'line', lang: $window.localStorage.getItem('lang')}),
        }
        
        api.models = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/model'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'model', lang: $window.localStorage.getItem('lang')}),
        }
        
        api.receivers = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/receiver'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'receiver', lang: $window.localStorage.getItem('lang')}),
        }
        
        api.categorys = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objectos/section_group'),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Objectos/objecto/:id/:table/:lang', 
                    {id: '@id', 'table' : 'section_group', lang: $window.localStorage.getItem('lang')}),
        }
        
        api.products = {
            list     : $resource('https://www.metrokidscompany.com/kulisha/api/Produtos/produtos/:lang',
                                {lang: $window.localStorage.getItem('lang')}),
            getById  : $resource('https://www.metrokidscompany.com/kulisha/api/Produtos/produto/:id/:lang', 
                    {id: '@id', lang: $window.localStorage.getItem('lang')}),
            update: $resource('https://www.metrokidscompany.com/kulisha/api/Produtos/updateMeta', 
                    {sku: '@sku', 'meta_title': '@meta_title'}, {
                update: {
                    method: 'POST'
                }
            })
