(function ()
{
    ...
    /** @ngInject */
    function ToolbarController($rootScope, $q, $state, $timeout, $mdSidenav, $translate, $mdToast, msNavigationService, $window)
    {
        var vm = this;
        ...
        function init()
        {
            ...
            vm.selectedLanguage = vm.languages[$window.localStorage.getItem('lang')];
