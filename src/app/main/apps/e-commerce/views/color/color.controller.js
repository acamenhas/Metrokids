(function ()
{
    ...
    /** @ngInject */
    function ColorController($document, $state, Color, $http)
    {
        var vm = this;
        ...
        vm.product = Color.record;
        vm.products = Color.aux;
        ...
        vm.gotoColorsSave = gotoColorsSave;
        ...
        function gotoColors()
        {
            $state.go('app.e-commerce.colors');
        }
        
        function gotoColorsSave()
        {
            var color_id = vm.product.color_id;
            var color_name_pt = vm.product.color_name_pt;
            var color_name_en = vm.product.color_name_en;
            var color_name_es = vm.product.color_name_es;
                        
            $http({
                url: 'https://www.metrokidscompany.com/kulisha/api/Objectos/update',
                method: "POST",
                data: { 'color_id': color_id, 'table': 'color', 'color_name_pt': color_name_pt, 'color_name_en': color_name_en, 'color_name_es': color_name_es },
                headers: {
            ...
            .then(function(response) {
                    // success
                $state.go('app.e-commerce.colors', {}, { reload: true });
            }, 
