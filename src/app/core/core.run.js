(function ()
{
    ...
    /** @ngInject */
    function runBlock(msUtils, fuseGenerator, fuseConfig, $state, $window)
    {
        /**
        ...
        var loginPage = '/pages/auth/login';
        if($window.localStorage.getItem('user') == null && $window.localStorage.getItem('lang') == null) {
            if(window.location.href.indexOf(loginPage) > -1) {
            } else {
