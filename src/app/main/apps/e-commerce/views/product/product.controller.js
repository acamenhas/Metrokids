(function ()
{
    ...
    /** @ngInject */
    function ProductController($document, $state, Product, api, $http)
    {
        var vm = this;
        ...
        vm.product = Product.record;
        vm.sizes = Product.sizes;
        vm.fotos = Product.fotos;
        ...
        function formupdate()
        {
            var sku = vm.product.sku;
            var meta_description = vm.product.meta_description;
            var meta_keyword = vm.product.meta_keyword;
            var meta_title = vm.product.meta_title;
 
            $http({
                url: 'https://www.metrokidscompany.com/kulisha/api/Produtos/updateMeta',
                method: "POST",
                data: { 'sku': sku, 'meta_description': meta_description, 'meta_keyword': meta_keyword, 'meta_title': meta_title },
                headers: {
            ...
            .then(function(response) {
                    // success
                $state.go('app.e-commerce.products', {}, { reload: true });
            }, 
